 ...
 <div class="container-fluid">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div id="menu4" class="tab-pane fade">
      ...
      $sql1="SELECT * FROM chat where receiver_id='$owner_id' ";
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="province" required="required">
                                ...
                                <option value="Province No. 1">Dhaka</option>
                                <option value="Province No. 2">Chottogram</option>
                                <option value="Bagmati Pradesh">Khulna</option>
                                <option value="Gandaki Pradesh">Rajshahi</option>
                                <option value="Province No. 5">Rongpur</option>
                                <option value="Karnali Pradesh">Sylhet</option>
                                <option value="Sudurpaschim Pradesh">Mymensingh</option>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select id="upazila" class="form-control" name="Upazila" required="required">
...
<script>
    ...
    document.getElementById("district").addEventListener("change", function() {
        ...
        if (selectedDistrict in sadarUpazilas) {
            sadarUpazilas[selectedDistrict].forEach(upazila => {
        ...
        if(mysqli_num_rows($result)>0)
      {
       ...
       ?>
                <tr>
                  ...
                  <td>Rs.<?php echo $rows['asking_price'] ?></td>
